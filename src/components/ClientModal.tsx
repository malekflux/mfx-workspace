...
export const ClientModal = ({ isOpen, onClose, client, onAddProject }: ClientModalProps) => {
  ...
  return <ModalPortal>
    <div ref={dialogRef} onMouseDown={(event) => closeOnBackdrop(event, onClose)} role="dialog" aria-modal="true" aria-label="Client form" className="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
