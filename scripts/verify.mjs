...
test('Internal project notes never appear in invoices or contracts',()=>{const privateNote='INTERNAL-ONLY-NOTE-4729';for(const kind of ['invoice','contract']){const html=generateDocument({kind,language:'en',clients:[client],projects:[{...project,notes:privateNote}],terms:'Approved terms'});assert.ok(!html.includes(privateNote));assert.ok(!html.includes('Project notes'));}});
